...
// Add this function at the top of the file after the Validator class
    ...
    if ($error != '') {
        ...
        if ($count == 1) {
            ...
            if (isset($_POST['remember_me']) && $_POST['remember_me'] == 'on') {
                ...
                $delete_old = "DELETE FROM remember_me_tokens WHERE user_id = '$user_id'";
...
<head>
    ...
    <title>Police Officer Portal - Login</title>
            ...
            <div class="col-md-5">
                <div class="card shadow-lg">
                    <div class="card-body p-5">
                        <div class="badge-police">Officer Portal</div>
                        <div class="text-center mb-4">
                            <h1 class="system-title">Police Officer Login</h1>
                            <p class="text-muted">Access your officer dashboard</p>
                        </div>
                        <form method="post">
                            <div class="form-group mb-3">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text">
                                        <i class="fas fa-user-shield" style="color: var(--police-gold);"></i>
                                    </span>
